            ...
            <main className="md:ml-64 pt-24 pb-12">
                <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-12">
                    ...
                    <div className="relative mb-12">
                        <div className="h-48 w-full bg-gradient-to-r from-brand-primary/20 via-brand-secondary/20 to-brand-accent/20 border border-white/5" />
                        <div className="absolute -bottom-10 left-8 flex items-end gap-6">
                            <div className="w-32 h-32 bg-black p-1 border border-white/10 shadow-2xl">
                                <img
                                    src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${resolvedUsername}`}
                                    className="w-full h-full object-cover"
                                />
                            </div>
                            <div className="pb-4">
                                <h1 className="text-3xl font-bold">Alex Rivera</h1>
                                <p className="text-white/40">@{resolvedUsername}</p>
                            </div>
                        ...
                        <div className="md:col-span-8">
                            <div className="mb-8 border-b border-white/5">
                                <div className="flex gap-8">
                                    <button className="pb-4 border-b-2 border-white text-white font-bold">Posts</button>
